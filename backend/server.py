...
async def register(user_data: UserCreate):
    ...
    user_doc = {
        ...
        "token_version": 0,  # For access token revocation (logout)
        "refresh_version": 0,  # For refresh token rotation
        "created_at": now
    }
...
async def record_login_failure(email: str, client_ip: str):
...
async def clear_login_attempts(email: str, client_ip: str):
