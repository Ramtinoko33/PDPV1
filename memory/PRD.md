...
## Pending
- [ ] P1 Finance Fase 2: parser open_documents (Exemplo de mapa.xlsx fica em "received") + comparação diária, pagamentos prováveis/parciais, notas de crédito, promessas cumpridas/falhadas automáticas contra nova importação, relatório semanal.
...
- [ ] P2 Finance: página Configurações (thresholds residuais editáveis — hoje por código: 1€/doc, 5€/cliente, 0.5%, 10 docs).
